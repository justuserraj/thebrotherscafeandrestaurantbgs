...
const categories = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1512058560366-cd2427ffbb62?q=80&w=600&auto=format&fit=crop",
    link: "#"
  }
];
    ...
    <section id="menu" className="py-24 bg-white">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16">
          ...
          <a href="#" className="mt-6 md:mt-0 flex items-center text-brand-orange font-semibold group">
            View Full Menu
